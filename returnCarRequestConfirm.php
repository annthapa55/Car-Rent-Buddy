<!--
php script displays the relevant information about the current renting transaction and 
updates a record at "assigned_car" table when the user confirms the return request. 
-->
<?php
